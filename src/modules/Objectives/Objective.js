...
export default function Objective() {
  return (
    <Grid container className="objective" id="objective">
      <Grid item className="objective  content-container">
        <Grid item className="objective motive-speech-box">
          <Typography className="objective motive-speech-box motive-speech">
        ...
        <Grid item className="objective key-content">
          <Grid item xs={12} lg={8} md={8} xl={8} className="objective key-content keys">
